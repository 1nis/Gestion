...
<html lang="en" >
   ...
   <body>
                     ...
                     <table id="table_info" class="table table-striped table-hover">
                        ...
                        <tbody>
                           ...
                           <?php
                              ...
                              $recuppersonne = 'SELECT COUNT(*) as nb_user  FROM pointage;';
                              ...
                              $sql = 'SELECT * FROM pointage ORDER BY ID ASC LIMIT :premier, :parpage;';
                           ...
                           <?php
                              foreach ($usernb as $users) 
                              {
                              	...
                              	<tr>
                              		<td>
                              			<span class="custom-checkbox">
                              				<input type="checkbox" id="checkbox1" name="',$users['usrid'],'" value="">
            ...
            <?php
               // Ici si l'utilisateur clique sur le bouton ajouter alors les valeurs sont directement ajouter dans la bdd dans la table user //
               	if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                          $mail_ajouter = $_POST['mailajouter'];
               		$ajouterpersonne = $connexion->query("INSERT INTO `pointage`(`Nom`, `Email`, `Date`, `usrid`) Select `Nom`,`Email`,NOW(),`ID` FROM user WHERE `Email` = '$mail_ajouter'");
      ...
      <script>
         // Script qui va prendre le focus de l'input dans le module addEmployeeeModal
         $("#add").click(function(){
      ...
      <script>
         // Script qui va permettre la détection d'écriture de l'utilisateur et s'il arête d'écrire au bout de X secondes le formulaires s'envoie.
         var searchTimer;
         var searchInterval = 400;
         
         $(() => {
           $('#mailajouter').on('input', (event) => {
